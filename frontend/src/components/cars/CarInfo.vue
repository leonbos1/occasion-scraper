    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div class="space-y-4">
                ...
                <a :href="'https://www.autoscout24.nl' + car.url" class="inline-block mr-2 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded transition duration-300">Go to offer</a>
